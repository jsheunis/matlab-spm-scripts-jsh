function [P, A0, x1, x2, x3, wt, deg, b, nrIter] = ...
   spm_realign_rt_jsh(P,flags, indVol, indFirstVol, A0, x1, x2, x3, wt, deg, b)
...
if indVol == indFirstVol
    ...
    %----------------------------------------------------------------------
    [V, P(1).C] = smooth_vol(P(1), flags.interp, flags.wrap, flags.fwhm); % smooth_vol(P, hld, wrp, fwhm), d  = [hld*[1 1 1]' wrp(:)];
